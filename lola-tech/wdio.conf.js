/* eslint-disable */
let browsers = require("./browser_config");
...
exports.config = {
  ...
  cucumberOpts: {
    ...
    tagExpression: process.env.tag, // <string> (expression) only execute the features or scenarios with tags matching the expression
