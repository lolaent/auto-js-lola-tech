...
Feature: Homepage
   ...
   Scenario: Verify Covid banner redirects to correct page
      ...
      Then The URL path is "https://lola-tech.webflow.io/covid19-our-bench-is-your-bench"
   ...
   Scenario: Verify Lola Tech logo redirects to homepage
      ...
      Then The URL path is "https://lola-tech.webflow.io"
   ...
   Scenario: Verify the Enterprise Level Software Delivery button redirects to the Software Delivery page
      ...
      Then The URL path is "https://lola-tech.webflow.io/work-with-us-devops-from-the-start"
